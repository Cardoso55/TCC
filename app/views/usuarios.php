...
<body>
    ...
    <div class="all">
        ...
        <div class="main-content">
            ...
            <div id="flash-container" style="position:fixed;top:10px;left:50%;transform:translateX(-50%);z-index:9999;">
            </div>
            ...
            <div class="middle-line">
                <h2 class="subtitle">Lista de Funcionários</h2>
                <button class="add-user" onclick="openModal()"><i class="fa-solid fa-plus"></i>Adicionar
                    Usuário</button>
            </div>
            ...
            <div id="editModal" class="modal-overlay" style="display:none;">
                <div class="modal-content">
                    ...
                    <form id="editForm" method="POST" action="/TCC/index.php?pagina=usuarios">
                        ...
                        <div class="juntarOsDois"><label>Ativo</label><input type="checkbox" name="ativo" id="edit-ativo"></div>
                ...
                <div class="modal-content">
                    ...
                    <form method="POST" action="/TCC/index.php?pagina=usuarios">
                        ...
                        <div class="password-requirements">
                            <p id="req-uppercase" class="invalid"><i class="fa-solid fa-x"></i> Maiúscula</p>
                            <p id="req-lowercase" class="invalid"><i class="fa-solid fa-x"></i>  Minúscula</p>
                            <p id="req-number" class="invalid"><i class="fa-solid fa-x"></i>  Número</p>
                            <p id="req-symbol" class="invalid"><i class="fa-solid fa-x"></i>  Símbolo (!@#$%...)</p>
                            <p id="req-length" class="invalid"><i class="fa-solid fa-x"></i> 8 a 20 caracteres</p>
                            <p id="req-match" class="invalid"><i class="fa-solid fa-x"></i> Senhas coincidem</p>
                        </div>
    ...
    <script>
        function showFlash(message, type = 'success', duration = 3000) {
            ...
            // remove após X segundos
            setTimeout(() => {
                flash.classList.remove('show');
                setTimeout(() => container.removeChild(flash), 400); // espera a anima sumir
            }, duration);
        }
        ...
        editForm.addEventListener('submit', async e => {
            ...
            // Se o checkbox "ativo" não estiver marcado, envia 0
            ...
            try {
                ...
                if (text.includes('success')) {
                    showFlash('Usuário editado com sucesso!', 'success');
                    editForm.reset();
                    fecharModal('editModal');
                    atualizarUsuarios(); // Atualiza a tabela
                } else {
                    showFlash('Erro ao editar usuário!', 'error');
                }
            } catch (err) {
                showFlash('Erro na conexão!', 'error');
                console.error(err);
            }
        });

        // Fechar modal
        document.getElementById('modalCloseBtn').addEventListener('click', () => fecharModal('editModal'));
        document.getElementById('modalCancelBtn').addEventListener('click', () => fecharModal('editModal'));
        document.getElementById('editModal').addEventListener('click', e => {
            if (e.target.id === 'editModal') fecharModal('editModal');
        });
