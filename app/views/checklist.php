...
if (!isset($_GET['tipo'])) {
    header("Location: ?pagina=checklist&tipo=compra");
    exit;
}
...
if (isset($_GET['idProduto']))
    $filtros['idProduto_TBL'] = $_GET['idProduto'];
if (isset($_GET['idCompra']))
    $filtros['idCompra_TBL'] = $_GET['idCompra'];
...
$userLevel = strtolower(trim($_SESSION['user_level'] ?? 'setor-de-vendas'));
$saidaPermitidos = ['setor-de-vendas'];
$compraPermitidos = ['operario', 'supervisor', 'gerente', 'diretor'];
...
<body>
    ...
    <div class="all">
        ...
        <div class="main-content">
            <h2 class="title">Checklists – <?= ucfirst($tipo) ?></h2>

            <?php if (!$checklists)
                echo "<p>Nenhum checklist encontrado.</p>"; ?>
